...
export function SearchPanel({ onCancel }: SearchPanelProps) {
  return (
    <div className="bg-white rounded-2xl h-full flex flex-col w-full overflow-hidden">
      {/* Logo Section */}
      <div className="bg-[#f8fafc] rounded-t-2xl p-4 flex items-center justify-center">
        <div className="bg-[#4a044e] rounded-xl w-32 h-32 flex items-center justify-center">
          <Image src="/top-6-logo.svg" alt="TOP 6" width={100} height={50} className="w-full" priority />
        </div>
      </div>
      ...
      <div className="p-4 flex-1">
        ...
        <div className="space-y-6">
          ...
          <Button className="bg-[#4a044e] hover:bg-[#3a033e] text-white rounded-xl h-12 px-8 text-lg">Add</Button>
        </div>
      </div>
